...
def findFirstReachedTwice(nums)
    freq = 0
    reached = [0]
    found = false
    while !found
...
# puts findFinalFreq(nums)
puts findFirstReachedTwice(nums)